...
public class Duckdns {
    ...
    static final String DuckDNSVersion = "DuckDns Updater (vs1.0.5)";
    final String TOOL_TIP = DuckDNSVersion;
    ...
    private void createAndAddApplicationToSystemTray() throws IOException {
        ...
        if (inputStream == null) {
            throw new FileNotFoundException("Cannot load logo.png from classpath.");
        }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (a == JOptionPane.OK_OPTION) {
                    ...
                    if (domainField.getText().length() > 0 && tokenField.getText().length() > 0) {
                        ...
                        prefs.put("refresh", String.valueOf(minuteField.getSelectedItem()));
                        String ip = getip();
                        //  prefs.put("oldipaddress", ip);
                        prefs.put("updatemessages", String.valueOf(UpdateField.getSelectedItem()));
